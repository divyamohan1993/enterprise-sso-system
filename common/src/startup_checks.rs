...
const SENSITIVE_ENV_VARS: &[&str] = &[
    ...
    "MILNET_ATTESTATION_SEED",
    "RATCHET_KEK",
    // Database credentials
    "DATABASE_URL",
    "DATABASE_REPLICA_URLS",
    "POSTGRES_PASSWORD",
    "MILNET_DB_REPLICA_URL",
    "MILNET_SAML_DB_URL",
    "MILNET_DB_SSL_KEY",
    "MILNET_DB_SSL_CERT",
    ...
    "MILNET_GATEWAY_KEY_PINS",
    "ADMIN_TLS_KEY",
    "ADMIN_TLS_CERT",
    "MILNET_REDIS_CA_CERT",
    // HSM/KMS configuration
    "MILNET_PKCS11_PIN",
    "MILNET_PKCS11_LIB",
    "MILNET_PKCS11_LIBRARY",
    "MILNET_HSM_BACKEND",
    "MILNET_HSM_KEY_LABEL",
    ...
    "MILNET_ALERT_WEBHOOK_URL",
    "MILNET_HEALTH_TOKEN",
    "MILNET_HEALTH_HMAC_KEY",
    "MILNET_SETUP_PROOF",
    "MILNET_TESTING_SINGLE_KEK_ACK",
    "GOOGLE_CLIENT_ID",
    "GOOGLE_CLIENT_SECRET",
    // Threshold secret sharing
    "MILNET_TSS_SHARE_SEALED",
    "MILNET_TSS_PUBLIC_KEY_PACKAGE",
    "MILNET_TSS_SIGNER_ADDRS",
    "RECEIPT_SIGNING_SEED_SEALED",
    "RECEIPT_SIGNING_KEY_SEALED",
    "SHARD_HMAC_KEY_SEALED",
    // Redis credentials
    "MILNET_REDIS_PASSWORD",
    "MILNET_REDIS_URL",
    "MILNET_RATE_LIMIT_REDIS_URL",
    // Crypto algorithm configuration
    "MILNET_PQ_KEM_ONLY",
    "MILNET_PQ_SIGNATURE_ALG",
    "MILNET_REQUIRE_MLKEM1024",
    "MILNET_PQ_TLS_ONLY",
    // BFT and deployment flags (sensitive operational config)
    "MILNET_BFT_SINGLE_PROCESS_ACK",
    "MILNET_TRUSTED_PROXIES",
];
