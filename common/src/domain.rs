...
pub const RECOVERY_CODE: &[u8] = b"MILNET-SSO-v1-RECOVERY-CODE";

// ── Admin RBAC domain separators ──
pub const ADMIN_ROLE_KEY_DERIVE: &[u8] = b"MILNET-SSO-v1-ADMIN-ROLE-KEY";
pub const CROSS_DOMAIN_AUDIT: &[u8] = b"MILNET-SSO-v1-CROSS-DOMAIN-AUDIT";
pub const PENDING_ADMIN_ACTION: &[u8] = b"MILNET-SSO-v1-PENDING-ADMIN-ACTION";
